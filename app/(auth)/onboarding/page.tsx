  ...
  useEffect(() => {
    ...
    const initializePage = async () => {
      try {
        ...
        console.log('[Onboarding] Page initialized, showing:', profile?.display_name ? 'plan_selection' : 'profile_setup');
      } catch (error) {
      ...
      <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center relative z-10">
          <motion.div
            ...
            className="relative"
          >
            <ShaderCanvas size={120} shaderId={2} />
              ...
              >
                ...
                >
                  <h1 className="text-2xl md:text-3xl font-light text-white mb-3 tracking-tight">
                    Bienvenido al <span className="text-violet-400 font-normal">Asistente Legal Inteligente</span>
                  </h1>
